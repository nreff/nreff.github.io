...
\begin{parts}
\part All polynomials $a_0+a_1 x+a_2 x^2$ for which $a_0=0$.
\part All polynomials $a_0+a_1 x+a_2 x^2$ for which $a_0+a_1+a_2=0$.
\part All polynomials $a_0+a_1 x+a_2 x^2$ for which $a_0$, $a_1$ and $a_2$ are integers.
\end{parts}
